...
| `cpu_total` | `total_cpu_mhz` | 單位為 MHz；需對齊基礎單位 (Millicores) |
| `cpu_provisioned` | `used_cpu_mhz` | 單位為 MHz；需對齊基礎單位 (Millicores) |
| `memory_total_bytes` | `total_memory_bytes` | 原始單位即為 **Bytes** |
| `memory_provisioned_bytes` | `used_memory_bytes` | 介接服務轉出的 **Bytes** |
| `disk_total_bytes` | `total_storage_bytes` | 原始單位即為 **Bytes** |
| `disk_provisioned_bytes` | `total_storage_bytes - free_storage_bytes` | 原始單位即為 **Bytes** |
